...
func (params CreateUserParams) Validate() []string {
	...
	if len(params.FirstName) < minFirstNameLen {
		errors = append(errors, fmt.Sprintf("firstName must be at least %d characters long", minFirstNameLen))
	}
	if len(params.LastName) < minLastNameLen {
		errors = append(errors, fmt.Sprintf("lastName must be at least %d characters long", minLastNameLen))
	}
